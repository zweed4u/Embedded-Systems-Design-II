...
CONFIG.NUM_MI {1} \
  ...
  connect_bd_net -net axi_gpio_0_gpio_io_o [get_bd_ports LED2] [get_bd_pins axi_gpio_0/gpio_io_o] [get_bd_pins ila_0/probe1]
  connect_bd_net -net blink_0_blink_out [get_bd_ports LED1] [get_bd_pins blink_0/blink_out] [get_bd_pins ila_0/probe0]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins axi_gpio_0/s_axi_aclk] [get_bd_pins blink_0/clk] [get_bd_pins ila_0/clk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins ps7_0_axi_periph/S00_ACLK] [get_bd_pins rst_ps7_0_50M/slowest_sync_clk]
