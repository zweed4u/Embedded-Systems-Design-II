...
# This is specific to ravvenlab.  Change per your setup
rootdir=/ravvenlab
...
create_fsbl() {
echo "Creating FSBL"
cd /media/sf_ravvenShare
#vivado -notrace -mode batch -source fsbl.tcl  
hsi -mode tcl -source fsbl.tcl  
}
...
cd /media/sf_ravvenShare
#vivado -notrace -mode batch -source device_tree.tcl  
hsi -mode tcl -source device_tree.tcl  
}
...
cp $rootdir/bootimage.bif $rootdir/bootfiles/bootimage.bif
#cp $rootdir/fsbl.elf $rootdir/bootfiles/fsbl.elf
cp $rootdir/fsbl/executable.elf $rootdir/bootfiles/fsbl.elf
...
cp $rootdir/snickerdoodle-linux/arch/arm/boot/uImage $rootdir/bootfiles/uImage.bin
...
#        [offest=<uimage_offset>]uImage.bin
#}
#EOF
