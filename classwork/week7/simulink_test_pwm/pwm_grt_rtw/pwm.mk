...
## 
## Makefile     : pwm.mk
## Generated on : Tue Feb 27 17:37:52 2018
## MATLAB Coder version: 3.3 (R2017a)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/pwm.exe
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/pwm.exe
...
INCLUDES_BUILDINFO = -I$(START_DIR) -I$(START_DIR)/pwm_grt_rtw -I$(START_DIR)/pwm -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common
...
DEFINES_STANDARD = -DMODEL=pwm -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DRT -DUSE_RTMODEL
...
SRCS = $(START_DIR)/pwm_grt_rtw/pwm.c $(START_DIR)/pwm_grt_rtw/pwm_data.c $(START_DIR)/pwm_grt_rtw/rtGetInf.c $(START_DIR)/pwm_grt_rtw/rtGetNaN.c $(START_DIR)/pwm_grt_rtw/rt_nonfinite.c rt_logging.c
...
OBJS = pwm.obj pwm_data.obj rtGetInf.obj rtGetNaN.obj rt_nonfinite.obj rt_logging.obj
