...
proc create_root_design { parentCell } {
  ...
  # Create instance: pwm_custom_axi_0, and set properties
  set pwm_custom_axi_0 [ create_bd_cell -type ip -vlnv user.org:user:pwm_custom_axi:1.1 pwm_custom_axi_0 ]
  ...
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M00_AXI [get_bd_intf_pins ps7_0_axi_periph/M00_AXI] [get_bd_intf_pins pwm_custom_axi_0/S00_AXI]

  # Create port connections
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins ps7_0_axi_periph/S00_ACLK] [get_bd_pins pwm_custom_axi_0/s00_axi_aclk] [get_bd_pins rst_ps7_0_49M/slowest_sync_clk]
  ...
  connect_bd_net -net pwm_custom_axi_0_pwm_ouput [get_bd_ports pwm_out] [get_bd_pins pwm_custom_axi_0/pwm_ouput]
  ...
  connect_bd_net -net rst_ps7_0_49M_peripheral_aresetn [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins pwm_custom_axi_0/s00_axi_aresetn] [get_bd_pins rst_ps7_0_49M/peripheral_aresetn]

  # Create address segments
  create_bd_addr_seg -range 0x00010000 -offset 0x43C00000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs pwm_custom_axi_0/S00_AXI/S00_AXI_reg] SEG_pwm_custom_axi_0_S00_AXI_reg
