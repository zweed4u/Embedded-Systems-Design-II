...
class Board(QtGui.QGraphicsView):
    def __init__(self, parent):
        ...
        self.leftBound = Bounds(self.boardWidth, self.boardHeight)
        self.rightBound = Bounds(self.boardWidth, self.boardHeight)
        self.scene.addItem(self.leftBound)
        self.scene.addItem(self.rightBound)
        self.leftBound.setPos(0, 0)
        self.rightBound.setPos(980, 0)
