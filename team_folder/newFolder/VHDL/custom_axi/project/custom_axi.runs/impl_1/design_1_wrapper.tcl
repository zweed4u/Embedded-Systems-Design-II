...
set rc [catch {
  ...
  set_property webtalk.parent_dir C:/dkaputa/custom_axi/project/custom_axi.cache/wt [current_project]
  set_property parent.project_path C:/dkaputa/custom_axi/project/custom_axi.xpr [current_project]
  set_property ip_repo_paths C:/dkaputa/custom_axi/ip [current_project]
  set_property ip_output_repo C:/dkaputa/custom_axi/project/custom_axi.cache/ip [current_project]
  set_property ip_cache_permissions {read write} [current_project]
  set_property XPM_LIBRARIES XPM_CDC [current_project]
  add_files -quiet C:/dkaputa/custom_axi/project/custom_axi.runs/synth_1/design_1_wrapper.dcp
  set_msg_config -source 4 -id {BD 41-1661} -suppress
  set_param project.isImplRun true
  add_files C:/dkaputa/custom_axi/src/design_1.bd
  set_property is_locked true [get_files C:/dkaputa/custom_axi/src/design_1.bd]
  set_param project.isImplRun false
  read_xdc C:/dkaputa/custom_axi/src/constraints.xdc
  set_param project.isImplRun true
