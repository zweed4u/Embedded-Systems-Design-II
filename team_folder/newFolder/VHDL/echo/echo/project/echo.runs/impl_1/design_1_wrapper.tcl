...
set rc [catch {
  ...
  set_property webtalk.parent_dir S:/echo/echo/project/echo.cache/wt [current_project]
  set_property parent.project_path S:/echo/echo/project/echo.xpr [current_project]
  set_property ip_repo_paths S:/echo/echo/ip [current_project]
  set_property ip_output_repo S:/echo/echo/project/echo.cache/ip [current_project]
  set_property ip_cache_permissions {read write} [current_project]
  set_property XPM_LIBRARIES XPM_CDC [current_project]
  add_files -quiet S:/echo/echo/project/echo.runs/synth_1/design_1_wrapper.dcp
