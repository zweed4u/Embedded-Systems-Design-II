...
CONFIG.max_count {50000000} \
  ...
  set echo_pulse_measurer_0 [ create_bd_cell -type ip -vlnv rit.edu:user:echo_pulse_measurer:1.0 echo_pulse_measurer_0 ]

  # Create instance: echo_pulse_measurer_1, and set properties
  set echo_pulse_measurer_1 [ create_bd_cell -type ip -vlnv rit.edu:user:echo_pulse_measurer:1.0 echo_pulse_measurer_1 ]

  # Create instance: echo_pulse_measurer_2, and set properties
  set echo_pulse_measurer_2 [ create_bd_cell -type ip -vlnv rit.edu:user:echo_pulse_measurer:1.0 echo_pulse_measurer_2 ]
...
CONFIG.NUM_MI {1} \
  ...
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins blink_0/clk] [get_bd_pins echo_pulse_measurer_0/clock_i] [get_bd_pins echo_pulse_measurer_1/clock_i] [get_bd_pins echo_pulse_measurer_2/clock_i] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins ps7_0_axi_periph/S00_ACLK] [get_bd_pins rst_ps7_0_50M/slowest_sync_clk] [get_bd_pins ultrasonic_sensor_axi_0/s00_axi_aclk]
  ...
  connect_bd_net -net rst_ps7_0_50M_peripheral_aresetn [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps7_0_50M/peripheral_aresetn] [get_bd_pins ultrasonic_sensor_axi_0/s00_axi_aresetn]
