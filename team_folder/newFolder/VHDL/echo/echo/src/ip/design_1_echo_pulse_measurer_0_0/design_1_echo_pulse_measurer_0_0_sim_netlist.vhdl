...
entity design_1_echo_pulse_measurer_0_0_echo_pulse_measurer is
  port (
  ...
  attribute ORIG_REF_NAME of design_1_echo_pulse_measurer_0_0_echo_pulse_measurer : entity is "echo_pulse_measurer";
end design_1_echo_pulse_measurer_0_0_echo_pulse_measurer;

architecture STRUCTURE of design_1_echo_pulse_measurer_0_0_echo_pulse_measurer is
  ...
  attribute SOFT_HLUTNM of \echo_pulse_length_o[0]_i_1\ : label is "soft_lutpair13";
  attribute SOFT_HLUTNM of \echo_pulse_length_o[10]_i_1\ : label is "soft_lutpair21";
  attribute SOFT_HLUTNM of \echo_pulse_length_o[11]_i_1\ : label is "soft_lutpair22";
  attribute SOFT_HLUTNM of \echo_pulse_length_o[12]_i_1\ : label is "soft_lutpair23";
  attribute SOFT_HLUTNM of \echo_pulse_length_o[13]_i_1\ : label is "soft_lutpair23";
  attribute SOFT_HLUTNM of \echo_pulse_length_o[14]_i_1\ : label is "soft_lutpair22";
  attribute SOFT_HLUTNM of \echo_pulse_length_o[15]_i_1\ : label is "soft_lutpair21";
  attribute SOFT_HLUTNM of \echo_pulse_length_o[16]_i_1\ : label is "soft_lutpair20";
  attribute SOFT_HLUTNM of \echo_pulse_length_o[17]_i_1\ : label is "soft_lutpair19";
  attribute SOFT_HLUTNM of \echo_pulse_length_o[18]_i_1\ : label is "soft_lutpair18";
  attribute SOFT_HLUTNM of \echo_pulse_length_o[19]_i_1\ : label is "soft_lutpair17";
  attribute SOFT_HLUTNM of \echo_pulse_length_o[1]_i_1\ : label is "soft_lutpair13";
  attribute SOFT_HLUTNM of \echo_pulse_length_o[20]_i_1\ : label is "soft_lutpair16";
  attribute SOFT_HLUTNM of \echo_pulse_length_o[21]_i_2\ : label is "soft_lutpair15";
  attribute SOFT_HLUTNM of \echo_pulse_length_o[2]_i_1\ : label is "soft_lutpair14";
  attribute SOFT_HLUTNM of \echo_pulse_length_o[3]_i_1\ : label is "soft_lutpair14";
  attribute SOFT_HLUTNM of \echo_pulse_length_o[4]_i_1\ : label is "soft_lutpair15";
  attribute SOFT_HLUTNM of \echo_pulse_length_o[5]_i_1\ : label is "soft_lutpair16";
  attribute SOFT_HLUTNM of \echo_pulse_length_o[6]_i_1\ : label is "soft_lutpair17";
  attribute SOFT_HLUTNM of \echo_pulse_length_o[7]_i_1\ : label is "soft_lutpair18";
  attribute SOFT_HLUTNM of \echo_pulse_length_o[8]_i_1\ : label is "soft_lutpair19";
  attribute SOFT_HLUTNM of \echo_pulse_length_o[9]_i_1\ : label is "soft_lutpair20";
  attribute SOFT_HLUTNM of edge_fall_i_1 : label is "soft_lutpair12";
  attribute SOFT_HLUTNM of edge_rise_i_1 : label is "soft_lutpair12";
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity design_1_echo_pulse_measurer_0_0_trigger_pulse_generator is
  port (
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of design_1_echo_pulse_measurer_0_0_trigger_pulse_generator : entity is "trigger_pulse_generator";
end design_1_echo_pulse_measurer_0_0_trigger_pulse_generator;

architecture STRUCTURE of design_1_echo_pulse_measurer_0_0_trigger_pulse_generator is
  ...
  signal trigger_pulse_o0_out : STD_LOGIC;
  ...
  attribute SOFT_HLUTNM : string;
  attribute SOFT_HLUTNM of \current_clock_count[0]_i_1\ : label is "soft_lutpair39";
  ...
  attribute SOFT_HLUTNM of \current_clock_count[17]_i_1\ : label is "soft_lutpair24";
  attribute SOFT_HLUTNM of \current_clock_count[18]_i_1\ : label is "soft_lutpair32";
  ...
  attribute SOFT_HLUTNM of \current_clock_count[26]_i_1\ : label is "soft_lutpair33";
  attribute SOFT_HLUTNM of \current_clock_count[27]_i_1\ : label is "soft_lutpair37";
  attribute SOFT_HLUTNM of \current_clock_count[28]_i_1\ : label is "soft_lutpair37";
  ...
  attribute SOFT_HLUTNM of \current_clock_count[30]_i_1\ : label is "soft_lutpair38";
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity design_1_echo_pulse_measurer_0_0_sensor_reader_top is
  port (
    trigger_pulse_o : out STD_LOGIC;
    echo_pulse_length_o : out STD_LOGIC_VECTOR ( 21 downto 0 );
    echo_pulse_length_ready_o : out STD_LOGIC;
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of design_1_echo_pulse_measurer_0_0_sensor_reader_top : entity is "sensor_reader_top";
end design_1_echo_pulse_measurer_0_0_sensor_reader_top;

architecture STRUCTURE of design_1_echo_pulse_measurer_0_0_sensor_reader_top is
  signal echo_pulse_measurer_inst_n_0 : STD_LOGIC;
begin
echo_pulse_measurer_inst: entity work.design_1_echo_pulse_measurer_0_0_echo_pulse_measurer
     port map (
      clock_i => clock_i,
      echo_pulse_i => echo_pulse_i,
      echo_pulse_length_o(21 downto 0) => echo_pulse_length_o(21 downto 0),
      \echo_pulse_length_o_reg[0]_0\ => echo_pulse_measurer_inst_n_0,
      echo_pulse_length_ready_o => echo_pulse_length_ready_o,
      enable_i => enable_i,
      reset_n_i => reset_n_i
    );
trigger_pulse_generator_inst: entity work.design_1_echo_pulse_measurer_0_0_trigger_pulse_generator
     port map (
      calc_finished_i => calc_finished_i,
      clock_i => clock_i,
      enable_i => enable_i,
      reset_n_i => echo_pulse_measurer_inst_n_0,
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity design_1_echo_pulse_measurer_0_0 is
  port (
    reset_n_i : in STD_LOGIC;
    clock_i : in STD_LOGIC;
    enable_i : in STD_LOGIC;
  ...
  attribute NotValidForBitStream of design_1_echo_pulse_measurer_0_0 : entity is true;
  attribute CHECK_LICENSE_TYPE : string;
  attribute CHECK_LICENSE_TYPE of design_1_echo_pulse_measurer_0_0 : entity is "design_1_echo_pulse_measurer_0_0,sensor_reader_top,{}";
  attribute downgradeipidentifiedwarnings : string;
  attribute downgradeipidentifiedwarnings of design_1_echo_pulse_measurer_0_0 : entity is "yes";
  attribute x_core_info : string;
  attribute x_core_info of design_1_echo_pulse_measurer_0_0 : entity is "sensor_reader_top,Vivado 2017.2";
end design_1_echo_pulse_measurer_0_0;

architecture STRUCTURE of design_1_echo_pulse_measurer_0_0 is
begin
U0: entity work.design_1_echo_pulse_measurer_0_0_sensor_reader_top
     port map (
      calc_finished_i => calc_finished_i,
      clock_i => clock_i,
      echo_pulse_i => echo_pulse_i,
