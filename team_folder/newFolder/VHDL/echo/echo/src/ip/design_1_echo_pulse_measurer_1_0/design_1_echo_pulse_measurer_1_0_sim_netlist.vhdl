...
entity design_1_echo_pulse_measurer_1_0_echo_pulse_measurer is
  port (
  ...
  attribute ORIG_REF_NAME of design_1_echo_pulse_measurer_1_0_echo_pulse_measurer : entity is "echo_pulse_measurer";
end design_1_echo_pulse_measurer_1_0_echo_pulse_measurer;

architecture STRUCTURE of design_1_echo_pulse_measurer_1_0_echo_pulse_measurer is
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity design_1_echo_pulse_measurer_1_0_trigger_pulse_generator is
  port (
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of design_1_echo_pulse_measurer_1_0_trigger_pulse_generator : entity is "trigger_pulse_generator";
end design_1_echo_pulse_measurer_1_0_trigger_pulse_generator;

architecture STRUCTURE of design_1_echo_pulse_measurer_1_0_trigger_pulse_generator is
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity design_1_echo_pulse_measurer_1_0_sensor_reader_top is
  port (
    trigger_pulse_o : out STD_LOGIC;
    echo_pulse_length_o : out STD_LOGIC_VECTOR ( 21 downto 0 );
    echo_pulse_length_ready_o : out STD_LOGIC;
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of design_1_echo_pulse_measurer_1_0_sensor_reader_top : entity is "sensor_reader_top";
end design_1_echo_pulse_measurer_1_0_sensor_reader_top;

architecture STRUCTURE of design_1_echo_pulse_measurer_1_0_sensor_reader_top is
  signal echo_pulse_measurer_inst_n_0 : STD_LOGIC;
begin
echo_pulse_measurer_inst: entity work.design_1_echo_pulse_measurer_1_0_echo_pulse_measurer
     port map (
      clock_i => clock_i,
...
trigger_pulse_generator_inst: entity work.design_1_echo_pulse_measurer_1_0_trigger_pulse_generator
     port map (
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity design_1_echo_pulse_measurer_1_0 is
  port (
    reset_n_i : in STD_LOGIC;
    clock_i : in STD_LOGIC;
    enable_i : in STD_LOGIC;
  ...
  attribute NotValidForBitStream of design_1_echo_pulse_measurer_1_0 : entity is true;
  attribute CHECK_LICENSE_TYPE : string;
  attribute CHECK_LICENSE_TYPE of design_1_echo_pulse_measurer_1_0 : entity is "design_1_echo_pulse_measurer_1_0,sensor_reader_top,{}";
  attribute downgradeipidentifiedwarnings : string;
  attribute downgradeipidentifiedwarnings of design_1_echo_pulse_measurer_1_0 : entity is "yes";
  attribute x_core_info : string;
  attribute x_core_info of design_1_echo_pulse_measurer_1_0 : entity is "sensor_reader_top,Vivado 2017.2";
end design_1_echo_pulse_measurer_1_0;

architecture STRUCTURE of design_1_echo_pulse_measurer_1_0 is
begin
U0: entity work.design_1_echo_pulse_measurer_1_0_sensor_reader_top
     port map (
      calc_finished_i => calc_finished_i,
      clock_i => clock_i,
      echo_pulse_i => echo_pulse_i,
