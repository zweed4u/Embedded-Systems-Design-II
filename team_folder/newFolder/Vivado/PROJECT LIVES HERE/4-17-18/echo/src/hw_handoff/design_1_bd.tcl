...
CONFIG.max_count {50000000} \
  ...
  set encoder_reader_top_0 [ create_bd_cell -type ip -vlnv rit.edu:user:encoder_reader_top:1.0 encoder_reader_top_0 ]

  # Create instance: encoder_reader_top_1, and set properties
  set encoder_reader_top_1 [ create_bd_cell -type ip -vlnv rit.edu:user:encoder_reader_top:1.0 encoder_reader_top_1 ]

  # Create instance: encoder_reader_top_2, and set properties
  set encoder_reader_top_2 [ create_bd_cell -type ip -vlnv rit.edu:user:encoder_reader_top:1.0 encoder_reader_top_2 ]

  # Create instance: encoder_reader_top_3, and set properties
  set encoder_reader_top_3 [ create_bd_cell -type ip -vlnv rit.edu:user:encoder_reader_top:1.0 encoder_reader_top_3 ]
...
CONFIG.NUM_WRITE_OUTSTANDING {1} \
 ] [get_bd_intf_pins /imu_wrapper_0/s00_axi]
...
CONFIG.NUM_MI {3} \
  ...
  set pwm_generator_0 [ create_bd_cell -type ip -vlnv rit.edu:user:pwm_generator:3.0 pwm_generator_0 ]

  # Create instance: pwm_generator_1, and set properties
  set pwm_generator_1 [ create_bd_cell -type ip -vlnv rit.edu:user:pwm_generator:3.0 pwm_generator_1 ]

  # Create instance: pwm_generator_2, and set properties
  set pwm_generator_2 [ create_bd_cell -type ip -vlnv rit.edu:user:pwm_generator:3.0 pwm_generator_2 ]

  # Create instance: pwm_generator_3, and set properties
  set pwm_generator_3 [ create_bd_cell -type ip -vlnv rit.edu:user:pwm_generator:3.0 pwm_generator_3 ]
  ...
  connect_bd_net -net motor_axi_0_clr_enc_a [get_bd_pins encoder_reader_top_0/reset_pulse_count_i] [get_bd_pins motor_axi_0/clr_enc_a]
  connect_bd_net -net motor_axi_0_clr_enc_b [get_bd_pins encoder_reader_top_1/reset_pulse_count_i] [get_bd_pins motor_axi_0/clr_enc_b]
  connect_bd_net -net motor_axi_0_clr_enc_c [get_bd_pins encoder_reader_top_2/reset_pulse_count_i] [get_bd_pins motor_axi_0/clr_enc_c]
  connect_bd_net -net motor_axi_0_clr_enc_d [get_bd_pins encoder_reader_top_3/reset_pulse_count_i] [get_bd_pins motor_axi_0/clr_enc_d]
  ...
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins blink_0/clk] [get_bd_pins echo_pulse_measurer_0/clock_i] [get_bd_pins echo_pulse_measurer_1/clock_i] [get_bd_pins echo_pulse_measurer_2/clock_i] [get_bd_pins encoder_reader_top_0/clock_i] [get_bd_pins encoder_reader_top_1/clock_i] [get_bd_pins encoder_reader_top_2/clock_i] [get_bd_pins encoder_reader_top_3/clock_i] [get_bd_pins imu_wrapper_0/s00_axi_aclk] [get_bd_pins motor_axi_0/s00_axi_aclk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins ps7_0_axi_periph/M01_ACLK] [get_bd_pins ps7_0_axi_periph/M02_ACLK] [get_bd_pins ps7_0_axi_periph/S00_ACLK] [get_bd_pins pwm_generator_0/clk] [get_bd_pins pwm_generator_1/clk] [get_bd_pins pwm_generator_2/clk] [get_bd_pins pwm_generator_3/clk] [get_bd_pins rst_ps7_0_50M/slowest_sync_clk] [get_bd_pins ultrasonic_sensor_axi_0/s00_axi_aclk]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins blink_0/reset_n] [get_bd_pins processing_system7_0/FCLK_RESET0_N]
  ...
  connect_bd_net -net rst_ps7_0_50M_peripheral_aresetn [get_bd_pins encoder_reader_top_0/reset_n_i] [get_bd_pins encoder_reader_top_1/reset_n_i] [get_bd_pins encoder_reader_top_2/reset_n_i] [get_bd_pins encoder_reader_top_3/reset_n_i] [get_bd_pins imu_wrapper_0/s00_axi_aresetn] [get_bd_pins motor_axi_0/s00_axi_aresetn] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/M01_ARESETN] [get_bd_pins ps7_0_axi_periph/M02_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins pwm_generator_0/reset_n] [get_bd_pins pwm_generator_1/reset_n] [get_bd_pins pwm_generator_2/reset_n] [get_bd_pins pwm_generator_3/reset_n] [get_bd_pins rst_ps7_0_50M/peripheral_aresetn] [get_bd_pins ultrasonic_sensor_axi_0/s00_axi_aresetn]
  connect_bd_net -net rst_ps7_0_50M_peripheral_reset [get_bd_pins echo_pulse_measurer_0/reset_n_i] [get_bd_pins echo_pulse_measurer_1/reset_n_i] [get_bd_pins echo_pulse_measurer_2/reset_n_i] [get_bd_pins rst_ps7_0_50M/peripheral_reset]
