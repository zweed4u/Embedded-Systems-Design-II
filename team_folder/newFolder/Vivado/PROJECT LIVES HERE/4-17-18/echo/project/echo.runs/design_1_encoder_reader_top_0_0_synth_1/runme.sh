...
HD_PWD='S:/echo/echo/project/echo.runs/design_1_encoder_reader_top_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_encoder_reader_top_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_encoder_reader_top_0_0.tcl
