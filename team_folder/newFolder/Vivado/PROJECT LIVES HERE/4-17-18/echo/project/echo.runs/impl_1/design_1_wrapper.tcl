...
set rc [catch {
  ...
  set_property webtalk.parent_dir {R:/CPET-563/groups/newFolder/Vivado/PROJECT LIVES HERE/4-17-18/echo/project/echo.cache/wt} [current_project]
  set_property parent.project_path {R:/CPET-563/groups/newFolder/Vivado/PROJECT LIVES HERE/4-17-18/echo/project/echo.xpr} [current_project]
  set_property ip_repo_paths {{R:/CPET-563/groups/newFolder/Vivado/PROJECT LIVES HERE/4-17-18/echo/ip}} [current_project]
  set_property ip_output_repo {{R:/CPET-563/groups/newFolder/Vivado/PROJECT LIVES HERE/4-17-18/echo/project/echo.cache/ip}} [current_project]
  set_property ip_cache_permissions {read write} [current_project]
  set_property XPM_LIBRARIES XPM_CDC [current_project]
  add_files -quiet {{R:/CPET-563/groups/newFolder/Vivado/PROJECT LIVES HERE/4-17-18/echo/project/echo.runs/synth_1/design_1_wrapper.dcp}}
  set_msg_config -source 4 -id {BD 41-1661} -suppress
  set_param project.isImplRun true
  add_files {{R:/CPET-563/groups/newFolder/Vivado/PROJECT LIVES HERE/4-17-18/echo/src/design_1.bd}}
  set_property is_locked true [get_files {{R:/CPET-563/groups/newFolder/Vivado/PROJECT LIVES HERE/4-17-18/echo/src/design_1.bd}}]
  set_param project.isImplRun false
  read_edif {{r:/CPET-563/groups/newFolder/Vivado/PROJECT LIVES HERE/4-17-18/echo/src/ip/design_1_imu_wrapper_0_0/imu.edn}}
  read_xdc {{R:/CPET-563/groups/newFolder/Vivado/PROJECT LIVES HERE/4-17-18/echo/src/constraints.xdc}}
  set_param project.isImplRun true
