...
CONFIG.NUM_MI {3} \
  ...
  set pwm_generator_0 [ create_bd_cell -type ip -vlnv rit.edu:user:pwm_generator:3.6 pwm_generator_0 ]

  # Create instance: pwm_generator_1, and set properties
  set pwm_generator_1 [ create_bd_cell -type ip -vlnv rit.edu:user:pwm_generator:3.6 pwm_generator_1 ]

  # Create instance: pwm_generator_2, and set properties
  set pwm_generator_2 [ create_bd_cell -type ip -vlnv rit.edu:user:pwm_generator:3.6 pwm_generator_2 ]

  # Create instance: pwm_generator_3, and set properties
  set pwm_generator_3 [ create_bd_cell -type ip -vlnv rit.edu:user:pwm_generator:3.6 pwm_generator_3 ]
