...
set rc [catch {
  ...
  set_property webtalk.parent_dir S:/echo/echo/project/newfolder_sys.cache/wt [current_project]
  set_property parent.project_path S:/echo/echo/project/newfolder_sys.xpr [current_project]
  set_property ip_repo_paths S:/echo/echo/ip [current_project]
  set_property ip_output_repo S:/echo/echo/project/newfolder_sys.cache/ip [current_project]
  set_property ip_cache_permissions {read write} [current_project]
  set_property XPM_LIBRARIES XPM_CDC [current_project]
  add_files -quiet S:/echo/echo/project/newfolder_sys.runs/synth_1/design_1_wrapper.dcp
  set_msg_config -source 4 -id {BD 41-1661} -suppress
  set_param project.isImplRun true
  add_files S:/echo/echo/src/design_1.bd
  set_property is_locked true [get_files S:/echo/echo/src/design_1.bd]
  set_param project.isImplRun false
  read_edif s:/echo/echo/src/ip/design_1_imu_wrapper_0_0/imu.edn
  read_xdc S:/echo/echo/src/constraints.xdc
  set_param project.isImplRun true
