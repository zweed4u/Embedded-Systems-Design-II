...
-- Command     : write_vhdl -force -mode funcsim S:/echo/echo/src/ip/design_1_blink_0_0/design_1_blink_0_0_sim_netlist.vhdl
...
architecture STRUCTURE of design_1_blink_0_0_blink is
  ...
  signal \count_sig0_carry__4_i_2_n_0\ : STD_LOGIC;
  signal \count_sig0_carry__4_i_3_n_0\ : STD_LOGIC;
  signal \count_sig0_carry__4_i_4_n_0\ : STD_LOGIC;
  ...
  signal \count_sig0_carry__5_i_1_n_0\ : STD_LOGIC;
...
\count_sig0_carry__4\: unisim.vcomponents.CARRY4
     port map (
      ...
      S(3) => \count_sig0_carry__4_i_1_n_0\,
      S(2) => \count_sig0_carry__4_i_2_n_0\,
      S(1) => \count_sig0_carry__4_i_3_n_0\,
      S(0) => \count_sig0_carry__4_i_4_n_0\
    );
...
\count_sig0_carry__4_i_2\: unisim.vcomponents.LUT1
    generic map(
      INIT => X"2"
    )
        port map (
      I0 => count_sig(23),
      O => \count_sig0_carry__4_i_2_n_0\
    );
\count_sig0_carry__4_i_3\: unisim.vcomponents.LUT1
    generic map(
      INIT => X"2"
    )
        port map (
      I0 => count_sig(22),
      O => \count_sig0_carry__4_i_3_n_0\
    );
\count_sig0_carry__4_i_4\: unisim.vcomponents.LUT1
    generic map(
      INIT => X"2"
    )
        port map (
      I0 => count_sig(21),
      O => \count_sig0_carry__4_i_4_n_0\
    );
\count_sig0_carry__5\: unisim.vcomponents.CARRY4
     port map (
      ...
      O(0) => data0(25),
      S(3 downto 1) => B"000",
      S(0) => \count_sig0_carry__5_i_1_n_0\
    );
\count_sig0_carry__5_i_1\: unisim.vcomponents.LUT1
    generic map(
      INIT => X"2"
    )
        port map (
      I0 => count_sig(25),
      O => \count_sig0_carry__5_i_1_n_0\
    );
