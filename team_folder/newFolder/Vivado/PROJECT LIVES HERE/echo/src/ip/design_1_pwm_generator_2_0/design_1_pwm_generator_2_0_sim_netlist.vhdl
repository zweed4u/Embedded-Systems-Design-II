...
-- Date        : Thu Apr 12 19:35:48 2018
-- Host        : ECTET-1360-04 running 64-bit major release  (build 9200)
-- Command     : write_vhdl -force -mode funcsim
--               s:/echo/echo/src/ip/design_1_pwm_generator_2_0/design_1_pwm_generator_2_0_sim_netlist.vhdl
-- Design      : design_1_pwm_generator_2_0
...
entity design_1_pwm_generator_2_0_pwm_generator is
  port (
    pwm_o : out STD_LOGIC;
    dir_o : out STD_LOGIC;
    dir : in STD_LOGIC;
  ...
  attribute ORIG_REF_NAME of design_1_pwm_generator_2_0_pwm_generator : entity is "pwm_generator";
end design_1_pwm_generator_2_0_pwm_generator;

architecture STRUCTURE of design_1_pwm_generator_2_0_pwm_generator is
  ...
  attribute SOFT_HLUTNM of \pwm_o__0\ : label is "soft_lutpair0";
begin
...
dir_sig_i_1: unisim.vcomponents.LUT1
    generic map(
      INIT => X"1"
    )
        port map (
...
dir_sig_reg: unisim.vcomponents.FDCE
    generic map(
      INIT => '0'
    )
        port map (
...
\pwm_o__0\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"28"
    )
        port map (
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity design_1_pwm_generator_2_0 is
  port (
    clk : in STD_LOGIC;
    reset_n : in STD_LOGIC;
    enable : in STD_LOGIC;
  ...
  attribute NotValidForBitStream of design_1_pwm_generator_2_0 : entity is true;
  attribute CHECK_LICENSE_TYPE : string;
  attribute CHECK_LICENSE_TYPE of design_1_pwm_generator_2_0 : entity is "design_1_pwm_generator_2_0,pwm_generator,{}";
  attribute downgradeipidentifiedwarnings : string;
  attribute downgradeipidentifiedwarnings of design_1_pwm_generator_2_0 : entity is "yes";
  attribute x_core_info : string;
  attribute x_core_info of design_1_pwm_generator_2_0 : entity is "pwm_generator,Vivado 2017.2";
end design_1_pwm_generator_2_0;

architecture STRUCTURE of design_1_pwm_generator_2_0 is
begin
U0: entity work.design_1_pwm_generator_2_0_pwm_generator
     port map (
      clk => clk,
      dir => dir,
      dir_o => dir_o,
