...
proc create_root_design { parentCell } {
  ...
  set my_pwm_0 [ create_bd_cell -type ip -vlnv rit.edu:user:my_pwm:1.0 my_pwm_0 ]
...
CONFIG.NUM_MI {1} \
  ...
  connect_bd_net -net rst_ps7_0_50M_peripheral_aresetn [get_bd_pins my_pwm_0/s00_axi_aresetn] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps7_0_50M/peripheral_aresetn]
